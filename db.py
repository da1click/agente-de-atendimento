...
def relatorio_marketing(account_id: int, data_inicio: str, data_fim: str) -> dict:
    ...
    # 1. Total de conversas que chegaram — usa ia_leads (registrado para todos os contatos,
    # independente da IA estar ativa) e filtra por created_at do período.
    # ia_mensagens foi abandonado aqui porque tem limite de 1000 linhas na query Supabase,
    # causando subcontagem em contas com alto volume.
    total_leads = 0
    try:
